...
const Login=()=> {
  ...
  <Bgdiv className="grid place-items-center h-screen">
    <div className="md:w-4/12 rounded-2xl ">  
    <div className='items-center'>
      <Singdet className='w-full h-16 my-20 p-4 bg-gray-200 border-2 rounded-lg' >
    ...
    <div className='flex absolute justify-end bottom-0 right-0' >
